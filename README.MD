...
You can [download the latest version of this application](https://bintray.com/schuettec/maven/download_file?file_path=com%2Fgithub%2Fschuettec%2Fmultiprocman%2Fmultiprocman%2F1.0.17%2Fmultiprocman-1.0.17-jar-with-dependencies.jar) as an executable JAR file from the Bintray repository.
...
You can choose to checkout to local and remote branches. If a remote branch is selected a new local tracking branch is created and checked out.
