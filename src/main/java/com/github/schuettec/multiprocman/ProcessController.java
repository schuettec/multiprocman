...
public class ProcessController implements ProcessCallback, ViewFrameListener {
    ...
    public ProcessController(ProcessDescriptor processDescriptor) {
        ...
        this.getTextPane().addAppendListener(counterExpressions);
    }
    ...
    private File createOutputFile() throws IOException {
        ...
        File file = new File("multiprocman_" + UUID.randomUUID().toString() + ".txt");
        try {
            file.createNewFile();
        } catch (Exception e) {
        }
    ...
    public void output(int lines, String line) {
        processListener.fire().processOutput(this);
