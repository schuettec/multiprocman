...
public class ApplicationEditor extends JDialog {
    ...
    private ApplicationEditor(ProcessDescriptor process, Component parent) {
                ...
                .addGroup(gl_terminatePanel.createSequentialGroup()
                        .addGroup(gl_terminatePanel.createParallelGroup(Alignment.LEADING)
                                .addGroup(Alignment.TRAILING, gl_terminatePanel.createSequentialGroup()
                                        .addContainerGap(103, Short.MAX_VALUE).addComponent(btnTermShowSubstitution)
                                        .addPreferredGap(ComponentPlacement.RELATED).addComponent(btnTermInsertVariable)
                                        .addPreferredGap(ComponentPlacement.RELATED).addComponent(btnTermFind,
                                                GroupLayout.PREFERRED_SIZE, 84, GroupLayout.PREFERRED_SIZE))
                                .addGroup(gl_terminatePanel.createSequentialGroup().addGap(29)
                                        .addGroup(gl_terminatePanel.createParallelGroup(Alignment.LEADING)
                                                .addComponent(chckbxTermUseVariableSubst, GroupLayout.DEFAULT_SIZE, 390,
                                                        Short.MAX_VALUE)
                                                .addComponent(scrollPane_3, GroupLayout.DEFAULT_SIZE, 390,
                                                        Short.MAX_VALUE)))
                                .addGroup(gl_terminatePanel.createSequentialGroup().addContainerGap().addComponent(
                                        rdbtnUseCustomCommand, GroupLayout.DEFAULT_SIZE, 413, Short.MAX_VALUE))
                                .addGroup(gl_terminatePanel.createSequentialGroup().addContainerGap().addComponent(
                                        rdbtnUseDefaultProcess, GroupLayout.DEFAULT_SIZE, 413, Short.MAX_VALUE)))
                        .addContainerGap()));
        gl_terminatePanel.setVerticalGroup(gl_terminatePanel.createParallelGroup(Alignment.LEADING)
                .addGroup(gl_terminatePanel.createSequentialGroup().addContainerGap()
                        .addComponent(rdbtnUseDefaultProcess).addPreferredGap(ComponentPlacement.RELATED)
                        .addComponent(rdbtnUseCustomCommand).addGap(5)
                        .addComponent(scrollPane_3, GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE).addGap(3)
                        .addComponent(chckbxTermUseVariableSubst).addPreferredGap(ComponentPlacement.UNRELATED)
                        .addGroup(gl_terminatePanel.createParallelGroup(Alignment.BASELINE).addComponent(btnTermFind)
                                .addComponent(btnTermInsertVariable).addComponent(btnTermShowSubstitution))
                        .addGap(19)));
        ...
        JLabel lblusevarnameTo = new JLabel(
                "<html>Use <tt>!{VAR_NAME}</tt> to reference user defined variables.</html>");
        GroupLayout gl_pnlVariables = new GroupLayout(pnlVariables);
        gl_pnlVariables
                .setHorizontalGroup(gl_pnlVariables.createParallelGroup(Alignment.LEADING)
                        .addGroup(gl_pnlVariables.createSequentialGroup().addContainerGap()
                                .addGroup(gl_pnlVariables.createParallelGroup(Alignment.LEADING)
                                        ...
                                        .addComponent(lblVariablesDefinedOn, GroupLayout.DEFAULT_SIZE, 499,
                                                Short.MAX_VALUE)
                                        .addComponent(lblusevarnameTo, GroupLayout.PREFERRED_SIZE, 499,
        ...
        this.promptVariables = new DefaultTableModel(new Object[][] {},
                new String[] { "Name", "Message", "Default", "Prompt", "Selection", "Selection values (CSV)" }) {
            /**
             *
             */
            private static final long serialVersionUID = 1L;
        ...
        tblVariables.getColumnModel().getColumn(0).setCellEditor(new IntegerEditor());
        ...
        JButton btnPlusVariables = new JButton(new AbstractAction(null, new ImageIcon(Resources.getPlus())) {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                promptVariables.addRow(new Object[] { "", "", "", true, false, "" });
            }
        });
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (row == -1) {
                    ...
                    if (promptVariables.getRowCount() > 0) {
                        tblVariables.setRowSelectionInterval(promptVariables.getRowCount() - 1,
                                promptVariables.getRowCount() - 1);
                    }
                }
            }
        });
        ...
        gl_counterPanel
                .setHorizontalGroup(
                        gl_counterPanel.createParallelGroup(Alignment.LEADING)
                                .addGroup(gl_counterPanel.createSequentialGroup().addContainerGap()
                                        .addGroup(gl_counterPanel.createParallelGroup(Alignment.LEADING)
                                                .addGroup(gl_counterPanel.createSequentialGroup()
                                                        .addComponent(scrollPane_2, GroupLayout.DEFAULT_SIZE, 436,
                                                                Short.MAX_VALUE)
                                                        .addContainerGap())
                                                .addGroup(gl_counterPanel.createSequentialGroup()
                                                        .addComponent(lblyouCanAdd, GroupLayout.DEFAULT_SIZE,
                                                                GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                        .addGap(0)))));
        gl_counterPanel.setVerticalGroup(gl_counterPanel.createParallelGroup(Alignment.LEADING)
                .addGroup(gl_counterPanel.createSequentialGroup().addContainerGap().addComponent(lblyouCanAdd).addGap(8)
                        .addComponent(scrollPane_2, GroupLayout.DEFAULT_SIZE, 379, Short.MAX_VALUE).addContainerGap()));

        tblExpressions = new JTable();
        this.expressions = new DefaultTableModel(new Object[][] {},
                new String[] { "Name", "Regular expressions", "Color" });
        tblExpressions.setModel(expressions);
        TableColumn column = tblExpressions.getColumnModel().getColumn(2);
        ...
        JButton btnPlusExpression = new JButton(new AbstractAction(null, new ImageIcon(Resources.getPlus())) {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                expressions.addRow(new Object[] { "", "", Color.GREEN });
            }
        });
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (row == -1) {
                    JOptionPane.showMessageDialog(ApplicationEditor.this,
                            "Please select the expression to remove first.", "No selection",
                            JOptionPane.WARNING_MESSAGE);
                } else {
                    expressions.removeRow(row);
                    if (expressions.getRowCount() > 0) {
                        tblExpressions.setRowSelectionInterval(expressions.getRowCount() - 1,
                                expressions.getRowCount() - 1);
                    }
                }
            }
        });
        ...
        gl_environmentPanel
                .setHorizontalGroup(gl_environmentPanel.createParallelGroup(Alignment.LEADING)
                        .addGroup(gl_environmentPanel.createSequentialGroup().addContainerGap()
                                .addGroup(gl_environmentPanel.createParallelGroup(Alignment.LEADING)
                                        .addGroup(gl_environmentPanel.createSequentialGroup()
                                                .addComponent(scrollPane_1, GroupLayout.DEFAULT_SIZE, 499,
                                                        Short.MAX_VALUE)
                                                .addContainerGap())
                                        .addComponent(lblNewLabel_1).addGroup(Alignment.TRAILING,
                                                gl_environmentPanel
                                                        .createSequentialGroup().addComponent(lblNewLabel_3,
        ...
        gl_environmentPanel.setVerticalGroup(gl_environmentPanel.createParallelGroup(Alignment.LEADING)
                .addGroup(gl_environmentPanel.createSequentialGroup().addContainerGap().addComponent(lblNewLabel_1)
                        .addGap(8).addComponent(scrollPane_1, GroupLayout.DEFAULT_SIZE, 405, Short.MAX_VALUE)
                        .addPreferredGap(ComponentPlacement.RELATED).addComponent(lblNewLabel_3).addGap(6)));

        tblEnv = new JTable();
        this.envVariables = new DefaultTableModel(new Object[][] {}, new String[] { "Variable name", "Value" });
                ...
                .addGroup(gl_contentPanel.createSequentialGroup().addContainerGap()
                        .addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPanel
                                .createSequentialGroup().addGroup(gl_contentPanel.createParallelGroup(
                                        Alignment.TRAILING).addComponent(lblPleaseFillIn, GroupLayout.DEFAULT_SIZE, 489,
                                                Short.MAX_VALUE)
                                        .addGroup(gl_contentPanel.createSequentialGroup().addGroup(gl_contentPanel
                                                .createParallelGroup(Alignment.LEADING).addGroup(gl_contentPanel
                                                        ...
                                                        .addComponent(lblName, GroupLayout.DEFAULT_SIZE,
                                                                GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                        .addComponent(
                                                                lblForIcon, GroupLayout.DEFAULT_SIZE, 94,
                                                                Short.MAX_VALUE))
                                                                ...
                                                                .addGroup(gl_contentPanel
                                                                        ...
                                                                        .addGroup(gl_contentPanel
                                                                                ...
                                                                                .addComponent(lblIcon,
                                                                                        ...
                                                                                        GroupLayout.PREFERRED_SIZE)
                                                                                .addPreferredGap(
                                                                                        ComponentPlacement.RELATED, 171,
                                                                                        Short.MAX_VALUE)
                                ...
                                .addGroup(gl_contentPanel.createSequentialGroup().addGroup(gl_contentPanel
                                        ...
                                        .addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING, false)
                                                .addComponent(lblColorFor, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE,
                                                        GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                .addComponent(lblCharset, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE,
                                                        95, Short.MAX_VALUE))
                                        .addComponent(
                                                lblWorkingDirectory, GroupLayout.PREFERRED_SIZE, 96,
                                                GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addGroup(gl_contentPanel.createParallelGroup(Alignment.TRAILING)
                                                .addComponent(txtWorkingDir, GroupLayout.DEFAULT_SIZE, 389,
                                                        Short.MAX_VALUE)
                                                .addComponent(chckbxEnablesExperimentalAscii, GroupLayout.DEFAULT_SIZE,
                                                        389, Short.MAX_VALUE)
                                                .addComponent(comboBox, 0, 389, Short.MAX_VALUE)
                                                .addGroup(gl_contentPanel.createSequentialGroup()
                                                        .addComponent(chckbxSubsitution, GroupLayout.DEFAULT_SIZE, 295,
                                                                Short.MAX_VALUE)
                                                        .addPreferredGap(ComponentPlacement.UNRELATED)
                                                        .addComponent(btnFindWorkingDir, GroupLayout.PREFERRED_SIZE, 88,
                                                                GroupLayout.PREFERRED_SIZE))
                                                .addGroup(gl_contentPanel.createSequentialGroup()
                                                        .addComponent(pnlColor, GroupLayout.PREFERRED_SIZE, 25,
                                                                GroupLayout.PREFERRED_SIZE)
                                                        .addPreferredGap(ComponentPlacement.RELATED, 265,
                                                                Short.MAX_VALUE)
                                                        .addComponent(btnSelectColor)))
                                        .addContainerGap()))));
        gl_contentPanel.setVerticalGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPanel
                .createSequentialGroup().addGap(8).addComponent(lblPleaseFillIn)
                .addPreferredGap(ComponentPlacement.RELATED)
                .addGroup(gl_contentPanel.createParallelGroup(Alignment.TRAILING)
                        .addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING, false)
                ...
                .addPreferredGap(ComponentPlacement.RELATED)
                .addGroup(gl_contentPanel.createParallelGroup(Alignment.BASELINE).addComponent(btnShowSubstitution)
                        .addComponent(btnInsertVariable).addComponent(btnFindApplication))
                .addPreferredGap(ComponentPlacement.RELATED)
                .addGroup(gl_contentPanel.createParallelGroup(Alignment.BASELINE)
                ...
                .addPreferredGap(ComponentPlacement.RELATED)
                .addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING).addComponent(chckbxSubsitution)
                ...
                .addPreferredGap(ComponentPlacement.UNRELATED)
                .addGroup(gl_contentPanel.createParallelGroup(Alignment.TRAILING)
                        .addGroup(gl_contentPanel.createParallelGroup(Alignment.BASELINE).addComponent(btnSelectColor)
                                .addComponent(lblColorFor))
                        .addComponent(pnlColor, GroupLayout.PREFERRED_SIZE, 26, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(ComponentPlacement.RELATED).addComponent(chckbxEnablesExperimentalAscii,
        ...
        gl_pnlGit.setHorizontalGroup(gl_pnlGit.createParallelGroup(Alignment.LEADING)
                .addGroup(gl_pnlGit.createSequentialGroup().addContainerGap()
                        .addGroup(gl_pnlGit.createParallelGroup(Alignment.LEADING)
                                ...
                                .addGroup(gl_pnlGit.createSequentialGroup().addGap(21).addComponent(
                                        checkPullAfterCheckout, GroupLayout.DEFAULT_SIZE, 478, Short.MAX_VALUE)))
                        .addContainerGap()));
        gl_pnlGit.setVerticalGroup(gl_pnlGit.createParallelGroup(Alignment.LEADING)
                .addGroup(gl_pnlGit.createSequentialGroup().addContainerGap()
                        ...
                        .addPreferredGap(ComponentPlacement.RELATED).addComponent(checkEnableGitSupport)
                        .addPreferredGap(ComponentPlacement.UNRELATED).addComponent(checkPullAfterCheckout)
    ...
    private AbstractAction insertVariableAction(final JTextArea textComponent) {
        return new AbstractAction("Insert variable") {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                Vector<String> keys = new Vector<>(System.getenv().keySet());
        ...
        if (isNull(process)) {
            ...
            if (processDescriptor.hasEnvironmentVariables()) {
                ...
                while (it.hasNext()) {
                    ...
                    if (!key.trim().isEmpty()) {
                        envVariables.addRow(new String[] { key.trim(), value });
                    }
                }
            }
            ...
            if (processDescriptor.hasCounters()) {
                for (Counter c : processDescriptor.getCounters()) {
                    expressions.addRow(new Object[] { c.getName(), c.getRegexp(), c.getColor() });
                }
            }
            ...
            if (processDescriptor.hasPromptVariables()) {
                for (PromptVariable pv : processDescriptor.getPromptVariables()) {
                    promptVariables.addRow(new Object[] { pv.getName(), pv.getMessage(), pv.getDefaultValue(),
                            pv.isPrompt(), pv.isSelection(), pv.getSelectionValuesAsCSV() });
                }
            }
        }
    }
    ...
    class IntegerEditor extends DefaultCellEditor {
        ...
        protected void revert() {
            ...
            for (int i = 0; i < deniedStrings.length; i++) {
                b.append("'").append(deniedStrings[i]).append("'");
