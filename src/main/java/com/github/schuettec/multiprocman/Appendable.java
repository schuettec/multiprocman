...
public interface Appendable {
	 ...
	 * @param s
	 *        The color to use.
	 * @param isSupportAsciiCodes
	 *        If <code>true</code> the ASCII backspace code is recognized to provide rudimental support for layouted
	 *        appends.
	 */
	...
	/**
	 * @param s
	 *        Appends this string with support for ANSI color codes.
	 * @param isSupportAsciiCodes
	 *        If <code>true</code> the ASCII backspace code is recognized to provide rudimental support for layouted
	 *        appends.
	 */
