...
public interface ProcessCallback {
     ...
     *
     * @param outputFile
     *            The output file that cannot be written to.
     * @param cause
     ...
     * </p>
     *
     * @param processOutputInfo
     *            Object that translated line numbers to byte offsets.
     * @param outputFile
     *            The file to capture the application output.
     * @param charset
     *            Chaset to be used for reading application output.
     */
