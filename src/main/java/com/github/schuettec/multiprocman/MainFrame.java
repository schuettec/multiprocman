...
public class MainFrame extends JFrame implements WindowListener, ProcessListener {
    ...
    private MainFrame() {
        ...
        this.processList.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                if (nonNull(selectedValue)) {
                    MainFrame.this.setTitle(WINDOW_TITLE + " - " + selectedValue.getProcessDescriptor().getTitle());
        ...
        mntmNewProcess = new JMenuItem(new AbstractAction("New...") {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                ProcessManager.getInstance().setVisible(true);
            }
        });
        ...
        mntmNewFromSearchProcess.setAccelerator(
        ...
        this.defaultToolbarButtons = Arrays
                .asList(new Component[] { btnClose, btnSave, btnClear, btnStop, btnRestart });
    }
    ...
    private void addGitToToolbarForAll() {
        allProcessesToolbar.add(new AbstractAction("", new ImageIcon(Resources.getBranch())) {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Enumeration<ProcessController> elements = processes.elements();
                while (elements.hasMoreElements()) {
                    ProcessDescriptor descriptor = elements.nextElement().getProcessDescriptor();
