...
public class PreferencesDialog extends JDialog {
    ...
    private PreferencesDialog(Preferences preferences, Component parent) {
                        ...
                        .addGroup(gl_environmentPanel.createSequentialGroup().addContainerGap()
                                .addGroup(gl_environmentPanel.createParallelGroup(Alignment.LEADING)
                                        ...
                                        .addComponent(lblNewLabel_1).addGroup(Alignment.TRAILING,
                                                gl_environmentPanel
                                                        .createSequentialGroup().addComponent(lblGlobalVariablesAre,
        ...
        gl_environmentPanel.setVerticalGroup(gl_environmentPanel.createParallelGroup(Alignment.LEADING)
                .addGroup(gl_environmentPanel.createSequentialGroup().addContainerGap().addComponent(lblNewLabel_1)
                        ...
                        .addComponent(lblGlobalVariablesAre).addContainerGap()));

        tblEnv = new JTable();
        this.variables = new DefaultTableModel(new Object[][] {}, new String[] { "Variable name", "Value" });
    ...
    private void initializeData(Preferences preferences) {
        preferences.getGlobalVariables().entrySet().stream()
                .forEach(entry -> this.variables.addRow(new Object[] { entry.getKey(), entry.getValue() }));
    }
