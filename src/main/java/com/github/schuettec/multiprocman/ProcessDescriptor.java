...
public class ProcessDescriptor implements Serializable {
    ...
    public void checkoutBranch(Component component, String branchName, ProgressMonitorView monitor)
            throws GitException {
    ...
    public static String _substituteGlobalVariables(String substitutedPromptVariables) {
        ...
        globalVariables.entrySet().stream().forEach(entry -> {
            String variableName = entry.getKey();
            String variableValue = entry.getValue();
            String placeholder = getVariablePlaceholder(PROMPT_VARIABLE_INDICATOR_CHAR, variableName);
            substitute.set(substitute.get().replaceAll("(?i)" + Pattern.quote(placeholder),
    ...
    /**
     * @return Returns the substituted command if environment variable substitution was enabled. Otherwise the command
